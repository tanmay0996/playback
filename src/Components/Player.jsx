...
const Player = () => {
    ...
    const {track,seekBar,seekBg,play,pause,playStatus,time,previous,next}=useContext(PlayerContext)
    ...
    return (
        <div className='h-[10%] bg-black flex  items-center text-white px-4 justify-between'>
            ...
            <div className='flex ml-4  w-[80%] gap-14'>
                <div className='flex flex-col items-center gap-1 m-auto '>
                    ...
                    <div className='flex items-center gap-5'>
                        ...
                        <div ref={seekBg} className='w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer'>
                            <hr ref={seekBar} className='h-1 border-none w-50 bg-green-800 rounded-full' />
                        </div>
